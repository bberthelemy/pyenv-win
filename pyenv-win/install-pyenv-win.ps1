...
Function Get-LatestVersion() {
    ...
    (New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/bberthelemy/pyenv-win/bberthelemy/.version", $LatestVersionFilePath)
...
Function Main() {
    ...
    (New-Object System.Net.WebClient).DownloadFile("https://github.com/bberthelemy/pyenv-win/archive/master.zip", $DownloadPath)
    ...
    Else {
        Write-Host "pyenv-win was not installed successfully. If this issue persists, please open a ticket: https://github.com/bberthelemy/pyenv-win/issues."
    }
}
